...
<script>
    $(function () {
        ...
        $.get('{{env('HOST_API_MASKER_STORE', null)}}/api/provinces', function ( data ) {
        ...
        $('select[name="province"]').change(function () {
            ...
            if ( $(this).val() !== 'null' ) {
                $.get('{{env('HOST_API_MASKER_STORE', null)}}/api/province/' + $(this).val(), function ( data ) {
                    $('select[name="city"]').prop('disabled', true);
        ...
        $('select[name="city"]').change(function () {
            ...
            if ( $(this).val() !== 'null' ) {
                $.get('{{env('HOST_API_MASKER_STORE', null)}}/api/subdistrict/' + $(this).val(), function ( data ) {
                    if ( data.rajaongkir.results ) {
        ...
        $('select[name="code_courier"]').change(function () {
            ...
            if ( $(this).val() !== 'null' ) {
                ...
                $.get('{{env('HOST_API_MASKER_STORE', null)}}/api/cost/' + subdistrict + '/' + (parseFloat($('#weight').html()) * 1000) + '/' + $(this).val(), function ( data ) {
                    if (data.rajaongkir.results) {
